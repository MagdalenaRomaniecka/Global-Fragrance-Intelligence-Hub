...
# -----------------------------------------------------------------------------
# 1. ATELIER SUPREME CSS - LUXURY ARCHITECTURE
# -----------------------------------------------------------------------------
...
st.markdown("""
    ...
    .report-frame { background: #080808; padding: 45px; border: 1px solid #222; box-shadow: 0 15px 40px rgba(0,0,0,0.6); color: #dfdfdf; line-height: 1.9; text-align: justify; margin: 30px auto; font-size: 1.1rem; width: 100%; max-width: 1200px; border-radius: 2px; }
...
with tabs[0]:
    ...
    with col_audio:
        ...
        if "Ep. 1" in episode:
            ...
            f_type, v_title, desc = "None", "Global Trade Volume 2024", "Hard data analysis of USA imports EU surplus and Russian domestic production."
            ...
            # EPISODE 5 - CROWNING ACHIEVEMENT
            current_t, current_a, rep_file = "ep5_summary_transcript.md", "ep5_audio.mp3", "macro_report_2026.md"
            f_type, v_title, desc = "None", "Master Strategic Synthesis 2026-2035", "Final dossier powered by Deep Research and analysis by Magdalena Romaniecka."
    ...
    # MASTER DOSSIER - VISIBLE IMMEDIATELY
    st.write("---")
    ...
    # TRANSKRYPCJA (DEBRIEF) - RESTORED IN EXPANDER
...
with tabs[3]:
    ...
    with e1:
        st.markdown("""<div class="project-card">
            ...
            <p style="color:#888; font-size:0.85rem;">Custom scraping engine for Eurasian markets, tracking real-time price fluctuations and consumer sentiment across 15 plus retailers.</p>
            <a class="btn-launch" href="https://github.com/MagdalenaRomaniecka" target="_blank">INTERNAL LAUNCH</a>
        </div>""", unsafe_allow_html=True)
    with e2:
        st.markdown("""<div class="project-card">
            <h4 style="color:#D4AF37; margin-top:0;">🧬 Kaggle Prediction</h4>
            <p style="color:#888; font-size:0.85rem;">Regression models calculating price elasticity and identifying the next Sol de Janeiro viral candidates using global datasets.</p>
            <a class="btn-launch" href="https://github.com/MagdalenaRomaniecka" target="_blank">ACCESS MODELS</a>
        </div>""", unsafe_allow_html=True)
    with e3:
        st.markdown("""<div class="project-card">
            ...
            <a class="btn-launch" href="https://github.com/MagdalenaRomaniecka" target="_blank">LIVE MONITOR</a>
        </div>""", unsafe_allow_html=True)
    with e4:
        st.markdown("""<div class="project-card">
            ...
            <a class="btn-launch" href="https://github.com/MagdalenaRomaniecka" target="_blank">LAUNCH AI HUB</a>
        </div>""", unsafe_allow_html=True)
