...
# 1. ATELIER SUPREME CSS (INSPIRED BY SCENTSATIONAL)
...
st.markdown("""
    ...
    /* Nagłówek i Ramki - PEŁNE CENTROWANIE */
    ...
    /* WYMUSZONE CENTROWANIE NAGŁÓWKÓW MARKDOWN */
    h1 { color: #D4AF37 !important; font-family: 'Tenor Sans' !important; text-align: center !important; border-bottom: 1px solid #D4AF37 !important; padding-bottom: 15px !important; text-transform: uppercase !important; font-size: 2rem !important; }
    ...
    /* VAULT CARD - CENTROWANIE I ZŁOTO */
...
stats = [("Global Beauty Sector", "$593.2B"), ("EU Market Growth", "+16.2%"), ("Poland Growth (Max)", "+75.3%"), ("Intelligence Precision", "91%")]
...
# TAB 2: MARKET ANALYTICS (Czytelny wykres)
with tabs[1]:
...
# TAB 3: FRAGRANCE VAULT (Zaokrąglony wynik i centrowanie)
with tabs[2]:
