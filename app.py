...
<p class="dossier-text" style="color:#D4AF37; border-left: 2px solid #D4AF37; padding-left: 15px; margin-top: 25px;"><strong>✦ AUGUST 2026 INTELLIGENCE UPDATE:</strong> FMCG Retail Data for Q2/Q3 2026 confirms that "Scent Stacking" regimens now officially constitute 41.2% of all sub-$50 beauty transactions in North America. This structural behavioral shift mathematically proves that Gen Z has neutralized the inflationary pressure of Section 122 tariffs by commoditizing the layering of mass-premium mists over purchasing single heritage Eau de Parfums.</p>
"""
    },
    "Ep. 4": {
        "debrief": """
...
<p class="dossier-text" style="color:#D4AF37; border-left: 2px solid #D4AF37; padding-left: 15px; margin-top: 25px;"><strong>✦ AUGUST 2026 INTELLIGENCE UPDATE:</strong> Recent Point of Sale (POS) metrics from Central Eastern Europe indicate that the Polish Rossmann network is currently processing over 1.4 million fragrance-related transactions daily. This hard metric validates that the physical infrastructure—acting as the 'Barbell Bottom' fulfillment center—remains fundamentally immune to the anticipated 33% e-commerce digital surge, as consumers strictly demand offline sensory auditing before committing capital.</p>
"""
    },
    "Ep. 5": {
        "debrief": """
...
<p class="dossier-text" style="color:#D4AF37; border-left: 2px solid #D4AF37; padding-left: 15px; margin-top: 25px;"><strong>✦ AUGUST 2026 INTELLIGENCE UPDATE:</strong> Q3 2026 corporate disclosures confirm a critical operational breakthrough: Carto AI architectures have successfully compressed the R&D cycle for neuro-active molecular compliance from 18 months down to just 3 weeks. This hyper-velocity in synthetic generation directly mitigates the massive financial bleed caused by mandatory physical reformulations under the new EU 2023/1545 constraints.</p>
"""
    },
    "Ep. 6": {
        "debrief": """
...
<p class="dossier-text" style="color:#D4AF37; border-left: 2px solid #D4AF37; padding-left: 15px; margin-top: 25px;"><strong>✦ AUGUST 2026 INTELLIGENCE UPDATE:</strong> Global Freight and Logistics Indexes for August 2026 reveal that despite sustained +400% ocean freight premiums on Red Sea corridors, UAE clone manufacturers operating out of Jebel Ali have officially captured 22% of the European middle-market. They achieved this by strictly leveraging 'Maceration Arbitrage' to drastically lower WIP (Work In Progress) capital holds, maintaining their aggressive $30 price points against deeply constrained Western designers.</p>
"""
    },
    "Ep. 7": {
        "debrief": """
...
<p class="dossier-text" style="color:#D4AF37; border-left: 2px solid #D4AF37; padding-left: 15px; margin-top: 25px;"><strong>✦ AUGUST 2026 INTELLIGENCE UPDATE:</strong> Following the strict enforcement deadlines of EU 2023/1545 in mid-2026, real-time secondary market scraping (via Kaggle & eBay) exposes a 315% price premium on pre-reformulation batches of polycyclic musk-heavy fragrances. This empirically confirms that 'Batch Code Hunters' are no longer a fringe subculture, but the primary drivers of massive grey-market inflation, actively trading on regulatory obsolescence.</p>
"""
    }
}
