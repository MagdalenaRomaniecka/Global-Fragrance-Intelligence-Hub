...
with tabs[0]:
    ...
    with col_audio:
        ...
        # Audio player triggers only if an .mp3 file is assigned
        if current_a:
            st.audio(current_a)
    ...
    with l_col:
        ...
        if current_t:
            ...
            st.markdown('<div class="report-frame" style="text-align: center; color: #888; font-style: italic;">Audio transcript is not applicable for the Global Foundation. Please refer to the Executive Master Dossier.</div>', unsafe_allow_html=True)
