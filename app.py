...
# -----------------------------------------------------------------------------
# 1. ATELIER SUPREME CSS - BALANCED LUXURY & RESPONSIVENESS
# -----------------------------------------------------------------------------
...
st.markdown("""
    ...
    /* FORCED GOLD HEADERS IN REPORTS */
    ...
    h3 { color: #D4AF37 !important; font-family: 'Tenor Sans' !important; border-left: 4px solid #D4AF37 !important; padding-left: 15px !important; font-size: 1.1rem !important; }
    ...
    .report-frame { background: #080808; padding: 35px; border: 1px solid #222; color: #dfdfdf; line-height: 1.8; text-align: justify; font-size: 1rem; }
    ...
    @media (max-width: 768px) {
        ...
        .report-frame { padding: 20px; font-size: 0.9rem; }
    }
    </style>
...
with tabs[4]:
    ...
    eco = [("🌍 Aromo Intelligence", "Russian market scraping engine and strategic dashboard.", "https://huggingface.co/spaces/Baphomert/Aromo-Market-Intelligence"), ("🔍 Perfume Finder", "Consumer recommendation PoC based on high-fidelity preference matching.", "https://perfume-finder-app-btskyvq7eytc5ujrgzr2dk.streamlit.app/"), ("📊 ScentSational Analytics", "Deep learning trend visualization and community mapping.", "https://scentsational-zbznjhgc4xv7faddappdc2b.streamlit.app/"), ("🧪 ScentSational LFS Hub", "Backend architecture for massive dataset management.", "https://baphomert-scentsational-fragrantica-lfs2.hf.space/")]
    e_cols = st.columns(2)
