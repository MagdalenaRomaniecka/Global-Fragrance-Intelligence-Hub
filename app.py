...
# -----------------------------------------------------------------------------
# 0. CONFIGURATION: FORCE DARK MODE SYSTEM-WIDE
# -----------------------------------------------------------------------------
...
st.markdown("""
    ...
    ul[data-baseweb="menu"] { background-color: #0e0e0e !important; }
    ...
    /* --- METRICS --- */
    .gold-metric {
        background-color: rgba(5, 5, 5, 0.5); border: 1px solid #222; padding: 25px; text-align: center; position: relative;
    }
    .gold-metric::before {
    ...
    .metric-label { color: #888; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 8px; }
    ...
    .footer {
        position: fixed; left: 0; bottom: 0; width: 100%; background-color: #000; color: #555; text-align: center; padding: 12px; font-size: 0.65rem; border-top: 1px solid #111; letter-spacing: 2px; z-index: 999; text-transform: uppercase;
    }
    </style>
...
with tab3:
    ...
    .project-title { color: #D4AF37 !important; font-family: 'Playfair Display', serif; font-size: 1.2rem; margin-bottom: 5px; font-weight: bold; }
    .project-desc { color: #888 !important; font-size: 0.8rem; margin-bottom: 20px; min-height: 40px; }
    .btn-row { display: flex; gap: 10px; }
    .btn-launch { flex: 1; background-color: #D4AF37 !important; color: #000 !important; padding: 10px; text-align: center; font-weight: bold; text-transform: uppercase; font-size: 0.75rem; border-radius: 2px; text-decoration: none !important; }
    .btn-launch:hover { background-color: #F0E68C !important; }
    .btn-code { flex: 1; background-color: transparent !important; color: #D4AF37 !important; border: 1px solid #444 !important; padding: 10px; text-align: center; text-transform: uppercase; font-size: 0.75rem; border-radius: 2px; text-decoration: none !important; }
    </style>
    
    <div class="project-container">
        <div class="project-card">
            <div class="project-title">🌍 Aromo Intelligence</div>
            <div class="project-desc">Global market scraping engine & trend forecasting dashboard.</div>
            <div class="btn-row">
        ...
        <div class="project-card">
            ...
            <div class="project-desc">Consumer recommendation system using similarity algorithms.</div>
            <div class="btn-row">
                <a href="#" target="_blank" class="btn-launch">🚀 Launch App</a>
        ...
        <div class="project-card">
            ...
            <div class="project-desc">Deep learning analysis of scent structures.</div>
        ...
        <div class="project-card">
            ...
            <div class="project-desc">Backend engineering pipeline & storage documentation.</div>
    ...
    with col_source:
         ...
         * **[2] Givaudan:** *2024 Half Year Results*
         * **[3] Journal of Retailing:** *Market analysis on consumer behavior*
         """)
...
st.markdown("""
    <div class="footer">
        DATA SOURCE: FRAGRANTICA & NOTEBOOKLM INSIGHTS <br>
